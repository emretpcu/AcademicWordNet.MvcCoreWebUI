    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginCode = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentInformations", x => x.LoginCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentLoginCode = table.Column<int>(type: "int", nullable: true),
                    Number = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StudentInformationLoginCode = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_StudentInformations_StudentInformationLoginCode",
                        column: x => x.StudentInformationLoginCode,
                        principalTable: "StudentInformations",
                        principalColumn: "LoginCode");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_StudentInformations_StudentLoginCode",
                        column: x => x.StudentLoginCode,
                        principalTable: "StudentInformations",
                        principalColumn: "LoginCode",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FromWhoId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BeenOpenedBefore = table.Column<bool>(type: "bit", nullable: false),
                    IsApporoved = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entries_Headings_HeadingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_StudentInformationLoginCode",
                table: "AspNetUsers",
                column: "StudentInformationLoginCode");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_StudentLoginCode",
                table: "AspNetUsers",
